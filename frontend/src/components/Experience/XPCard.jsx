...
export default function XPCard(props) {
  ...
  return (
    <div className="shadow-glow-sm rounded-3xl h-fit w-fit mx-4">
      <div className="border-2 border-gray-600 flex flex-col justify-center items-center rounded-3xl h-fit w-[350px] px-8 py-4 shadow-inner shadow-white/75 bg-lightBg/70 backdrop-blur-md">
        ...
        <div className="w-full flex flex-col pt-4 justify-end items-end">
          ...
          <div className="font-primary font-extrabold text-accent">{date}</div>
        </div>
      </div>
    </div>
  );
